...
class SafetyStop(Node):
    def __init__(self):
        ...
        self.declare_parameter('warning_distance', 0.10)
        self.declare_parameter('danger_distance', 0.06)
        ...
        self.pre_danger_distance = self.get_parameter('danger_distance').get_parameter_value().double_value
        ...
        self.warning_distance = self.lidar_offset + self.pre_warning_distance
        self.danger_distance = self.lidar_offset + self.pre_danger_distance
