...
#define L298N_in4 42 //30  // Dir Motor B
#define L298N_in3 43 //31  // Dir Motor B
#define L298N_in2 44 //32  // Dir Motor A
#define L298N_in1 45 //33  // Dir Motor A
...
void loop() {
  ...
  {
    right_wheel_meas_vel = (10 * right_encoder_counter * (60.0/3930.0)) * 0.10472;
    left_wheel_meas_vel = (10 * left_encoder_counter * (60.0/3930.0)) * 0.10472;
