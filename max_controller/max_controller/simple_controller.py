...
class SimpleController(Node):
    def __init__(self):
        ...
        self.vel_sub_ = self.create_subscription(Twist, 'max_controller/cmd_vel', self.velCallback, 10)
        self.joint_sub_ = self.create_subscription(JointState, 'joint_states', self.jointCallback, 10)
        self.odom_pub_ = self.create_publisher(Odometry, 'max_controller/odom', 10)
    ...
    def velCallback(self, msg):
        ...
        wheel_speed_msg.data = [wheel_speed[1,0],  # FL  ## 0,0 Left wheel velocity, 0,1 Right wheel velocity
                                wheel_speed[0,0],  # FR
                                wheel_speed[1,0],  # RL
                                wheel_speed[0,0]]  # RR
